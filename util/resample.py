...
def resample(density_map: DensityMap, voxel_size=0.5, contour=None, dimension_spec=None) -> DensityMap:
    """
    ...
    :param (optional) voxel_size: ReSample voxel size (Note: 0.5 will only reSample the top 1% value's 3D space)
    ...
    resample_mrc(temp_map_dir, temp_map_dir, voxel_size, contour=contour, dimension_spec=dimension_spec)
