...
if __name__ == "__main__":
    ...
    from conditioning_preprocessing import ConditioningDataset
    import h5py
    import argparse
    ...
    hdf5 = h5py.File(os.path.join(args.dataset_dir, 'SR_CryoEM_LocalRes_dataset.hdf5'), 'r')
    train_set = ConditioningDataset(hdf5['train'])
