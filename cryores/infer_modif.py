...
def test(model_ori, model_reshape, mappath, device_ori, device_reshape):
    ...
    output_dict = {
        ...
        "map_level": level,
        "localres_path": localres_path,
    }
    return output_dict

def prediction(mappath, device, ckpt_path):
